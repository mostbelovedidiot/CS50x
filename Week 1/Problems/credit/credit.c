...
int main (void)
{
    ...
    do 
    {
        cardNumber = get_long("Please input your #\n");
    }
    while (cardNumber < 0);
    ...
    long cardNumberForEvenLoop = cardNumber;
    for (int i = 0; i <= 8; i++)
    {
    ...
    long cardNumberForOddLoop = cardNumber;
    for (int i = 0; i <= 8; i++)
    {
    ...
    long cardNumberShortened = cardNumber / 1000000000000;
